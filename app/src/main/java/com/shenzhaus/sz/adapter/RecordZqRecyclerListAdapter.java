...
public class RecordZqRecyclerListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecordZqRecyclerListAdapter(Context mContext, ArrayList<DanmuMessage> mVideoItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            return new MessageViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_record_zq, parent, false));
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeaderHolder) {
            ...
            temp.zq_name.setText(t.getMessageContent());
            temp.zq_result.setText(t.getUserName());
